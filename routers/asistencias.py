...
@asistencia_router.get("/historial/personal", response_model=List[AsistenciaResponse])
...
@asistencia_router.get("/historial/personal/{personal_id}", response_model=List[AsistenciaResponse])
...
@asistencia_router.get("/historial/buscar/personal", response_model=List[AsistenciaResponse])
...
@asistencia_router.get("/historial/clientes", response_model=List[AsistenciaResponse])
...
@asistencia_router.get("/historial/clientes/{cliente_id}", response_model=List[AsistenciaResponse])
...
@asistencia_router.get("/historial/buscar/clientes", response_model=List[AsistenciaResponse])
