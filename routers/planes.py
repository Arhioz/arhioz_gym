...
import schemas, crud.crud_planes as crud_planes
...
@plan_router.post("/", response_model=schemas.PlanMembresiaResponse, status_code=status.HTTP_201_CREATED)
...
@plan_router.put("/{plan_id}", response_model=schemas.PlanMembresiaResponse)
